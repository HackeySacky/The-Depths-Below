...
if Name == "Edgar" or Name == "David" or Name == "Daniel":
 Name = input("Well, That is...interesting, {}. That couldn't possibly be your name.\n".format(Name))
 time.sleep(3)
...
print("You don't remember having a voice in your head. You decide to ask it what it is and what is going on.")
time.sleep(2)
print("It tells you that it is the voice of a disembodied spirit that died here before you.\n It also informs you that you are in an underground complex that is a vampire's lair."
      "You will be it's next meal if you don't escape, but be careful...\n The vampire's servants, the drudge are patrolling the area to prevent your escape.")
time.sleep(10)
x = 0
y = 0
while x >= 3:
...
print('You look around the room. It has rough hewn walls of solid stone and there is a heavy door set securely into one of the walls.')
time.sleep(2)
...
if ex == 'Kick':
    ...
    print('That typo caused a heart attack!!!, your body was later found scattered around the mysterious dungeon.\n\n----------GAMEOVER----------\n')
    os.system("PAUSE")
    exit()
time.sleep(3)
...
time.sleep(3)
dumb = input("You edge ever so slowly towards the monster by the door. You freeze. You notice that the drudge seems to have heard you as it's ears are perked up.\n"
      "Do you make a run for it and try to get past the creature quickly or do you hide and hope it doesn't notice you. [Run/Hide]\n")
time.sleep(4)
if dumb == 'Run':
    print ('You foolishly decide to make a brake for it. The drudge instantly spots you and pounces on you, tearing out your throat.\n\n--------GAMEOVER--------\n')
    os.system("PAUSE")
    exit()
elif dumb == "Hide":
...
while not bon == 'Hide' and not 'Escape':
    ...
    bon = input('There are no other ways out of the room besides the way you came in.\n'
            ...
            'Do you try and leave the room or do you hide amongst the piles of bones?  [Hide/Escape}\n')
if bon == 'Escape':
    print('Dummkopf, you rush out of the room and run straight into your pursuer.\n'
...
if esc == 'Wait':
    ...
    print('You creep up on the monster wielding a femur bone. Quickly you use all you might and swing at his head.\n'
...
lost = input("You manage to lose him, but now you are hopelessly lost yourself. You see a cabin in the distance. Do you go to investigate it?  [Y/N]")
...
trap = input("AGHHHHH!! You're foot gets caught in a bear-trap. Do you chew it off or leave it?  [Chew it off/Wait]")
...
if trap == 'Wait':
    ...
    print('You gnaw of your foot and continue towards the cabin on your stump leg.')
time.sleep(2)

cabin = input('You look inside the cabin. Shia LaBeouf is inside! Do you try to kill him or run away?  [Run/Attack]')
while not cabin == 'Run' and cabin == 'Attack':
    print('Last time for sure.')
    cabin = input('You look inside the cabin. Shia LaBeouf is inside! Do you try to kill him or run away?  [Run/Attack]')
if cabin == 'Run':
    print('You limp away from the scene as fast as you can. Unfortunately you catch an infection in your leg and die.\n--------GAMEOVER-------\n\n')
    os.system("PAUSE")
    exit()
elif cabin == 'Attack':
    print('You go on the offensive against the cannibal.')
time.sleep(2)

fight = input('You enter the cabin. You find a knife on the table and sneak up behind Shia LaBeouf. Do you strangle him or stab him? [Strangle/Stab]')
...
if fight == 'Strangle':
    ...
    print('You stab him in his kidney and he falls heavily to the ground. You did it, now it is time to get going.')
time.sleep(3)

print("But he isn't dead Shia surprise!/n")
time.sleep(2)
